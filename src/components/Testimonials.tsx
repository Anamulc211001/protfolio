      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Client <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">Testimonials</span>
          </h2>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="absolute -top-4 left-6">
                <div className="bg-gradient-to-r from-purple-500 to-blue-600 p-3 rounded-full shadow-lg backdrop-blur-sm border border-white/20">
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gradient-to-r from-purple-400 to-blue-600 rounded-full flex items-center justify-center text-white font-bold mr-4">
                  {testimonial.avatar}
                </div>
                <div>
