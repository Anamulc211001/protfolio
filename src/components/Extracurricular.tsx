      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Extracurricular <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">Activities</span>
          </h2>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div className="flex-1">
                  <div className="px-3 py-1 bg-gradient-to-r from-purple-500/20 to-blue-600/20 backdrop-blur-sm text-purple-300 text-sm rounded-full border border-white/20 inline-block mb-2">
                    {activity.category}
                  </div>
                </div>
              </div>
        ...
        <div className="bg-gradient-to-r from-purple-500 to-blue-600 rounded-2xl p-8 text-white">
          <div className="text-center mb-8">
            ...
            <p className="text-purple-100">Recognition and awards for excellence</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {achievements.map((achievement, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                ...
                <p className="text-purple-100 text-sm mb-2">{achievement.description}</p>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Coding', 'Teaching', 'Travelling', 'Learning', 'Reading', 'Cricket', 'Badminton'].map((hobby, index) => (
              <span
                key={index}
                className="px-4 py-2 bg-white/5 backdrop-blur-lg text-gray-200 rounded-full border border-white/20 hover:border-purple-400/50 hover:text-purple-400 transition-all duration-300"
              >
                {hobby}
              </span>
            ))}
